...
public class FormPhongBan extends javax.swing.JPanel {
    ...
    String path = "src/controller/PB.dat";

    public FormPhongBan() {
        initComponents();
        String[] col = {"Ma Phong", "Ten", "Mo Ta", "He so"};
    ...
    private void btThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemActionPerformed
        ...
        try {
            ...
            PhongBan tmp = new PhongBan(ma, ten, mota, heso);
            list.add(tmp);
            ...
            JOptionPane.showMessageDialog(this, "He So tu 1 den 20!");
            return;
        }
