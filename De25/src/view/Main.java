...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        initComponents();
        FormCongNhan f1=new FormCongNhan();
        jTabbedPane1.addTab("Cong Nhan", f1);
        
        FormXuong f2=new FormXuong();
        jTabbedPane1.addTab("Xuong San Xuat", f2);
        
        FormQuanLy f3=new FormQuanLy();
        jTabbedPane1.addTab("Danh Sach Cham Cong", f3);
    }
