...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        initComponents();
        FormGiangVien f1 = new FormGiangVien();
        jTabbedPane1.addTab("Giang Vien", f1);
        FormMonHoc f2 = new FormMonHoc();
        jTabbedPane1.addTab("Mon Hoc", f2);
        
        FormQuanLy f3 = new FormQuanLy();
        jTabbedPane1.addTab("Bang ke khai giang day", f3);
    }
