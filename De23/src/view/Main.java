...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        initComponents();
        FormMatHang f1=new FormMatHang();
        jTabbedPane1.addTab("Mat Hang", f1);
        FormNhanVien f2=new FormNhanVien();
        jTabbedPane1.addTab("Nhan Vien Ban Hang", f2);
        FormQuanLy f3=new FormQuanLy();
        jTabbedPane1.addTab("Danh sach ban hang", f3);
    }
