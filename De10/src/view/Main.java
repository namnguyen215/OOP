...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        initComponents();
        FormCauThu f1=new FormCauThu();
        jTabbedPane1.addTab("Cau Thu", f1);
        FormViTri f2=new FormViTri();
        jTabbedPane1.addTab("Vi Tri", f2);
        FormQuanLy f3=new FormQuanLy();
        jTabbedPane1.addTab("Phan Cong Cau Thu", f3);
    }
