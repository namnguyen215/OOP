...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        initComponents();
        FormMonHoc f1=new FormMonHoc();
        jTabbedPane1.addTab("Mon Hoc", f1);
        FormGiangVien f2=new FormGiangVien();
        jTabbedPane1.addTab("Giang Vien", f2);
        FormQuanLy f3=new FormQuanLy();
        jTabbedPane1.addTab("Bang Dang Ky", f3);
    }
