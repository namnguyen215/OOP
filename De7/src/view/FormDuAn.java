...
public class FormDuAn extends javax.swing.JPanel {
    ...
    String path = "src/controller/DA.dat";

    public FormDuAn() {
        initComponents();
        String[] cot = {"Ma", "Ten", "Kieu", "Kinh Phi"};
    ...
    private void btThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemActionPerformed
        ...
        try {
            ...
            kinhphi = Double.parseDouble(jTextField3.getText());
            DuAn tmp = new DuAn(ma, ten, kieu, kinhphi);
            list.add(tmp);
