...
public class FormCongNhan extends javax.swing.JPanel {
    ...
    public FormCongNhan() {
        initComponents();
        String[] col = {"Ma CN", "Ten", "Dia Chi", "Ca"};
    ...
    private void showContent(int i) {
        ...
        jComboBox1.setSelectedItem(jTable1.getValueAt(i, 3) + "");
    }
    ...
    private void btThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemActionPerformed
        ...
        try {
            ...
            CongNhan tmp = new CongNhan(ma, ten, diachi, ca);
            list.add(tmp);
            tm.addRow(tmp.toObjects());

        } catch (TrongEx e) {
            JOptionPane.showMessageDialog(this, "Khing de trong!");
            return;
        }
