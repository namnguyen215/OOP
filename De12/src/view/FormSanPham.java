...
public class FormSanPham extends javax.swing.JPanel {
    ...
    String path = "src/controller/SP.dat";

    public FormSanPham() {
        initComponents();
        String[] col = {"Ma CN", "Ten", "Don gia"};
    ...
    private void btThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemActionPerformed
        ...
        try {
            ...
            dongia = Double.parseDouble(jTextField3.getText());
            SanPham tmp = new SanPham(ma, ten, dongia);
            list.add(tmp);
            ...
            JOptionPane.showMessageDialog(this, "Kiem tra lai don gia!");
            return;
