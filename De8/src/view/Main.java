...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        initComponents();
        FormPhongHoc f1=new FormPhongHoc();
        jTabbedPane1.addTab("Phong Hoc", f1);
        
        FormLopHoc f2=new FormLopHoc();
        jTabbedPane1.addTab("Lop Hoc", f2);
        
        FormQuanLy f3=new FormQuanLy();
        jTabbedPane1.addTab("Bang Sap Xep", f3);
    }
